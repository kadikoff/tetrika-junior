tests = [
    ...
    # присутствовали - не пересекались
    {
        'intervals':
            {
                'lesson': [100, 200],
    ...
    # присутствовали - пересечение нахлёст
    {
        'intervals':
            {
                'lesson': [100, 200],
    ...
    # присутствовали - один интервал внутри другого
    {
        'intervals':
            {
                'lesson': [100, 200],
    ...
    # присутствовали - оба от начала до конца
    {
        'intervals':
            {
                'lesson': [100, 200],
